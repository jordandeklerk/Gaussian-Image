...
from utils import seed_everything, calculate_psnr, ImageProcessor
from parser import args


def train_model(model, optimizer, target, xy_grid, epochs=args.epochs, display_epochs=args.display_epochs):
    seed_everything()
    snapshots = []
    train_psnrs = []
    test_psnrs = []
